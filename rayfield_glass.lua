...
local function applyGlass(obj)
    if obj:IsA("Frame") or obj:IsA("TextButton") or obj:IsA("ImageButton") then
        ...
        obj.MouseEnter:Connect(function()
            TweenService:Create(obj,TweenInfo.new(0.15,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{BackgroundTransparency=math.clamp(obj.BackgroundTransparency+0.08,0,1),Position=basePos+UDim2.fromOffset(0,-2)}):Play()
            if obj:FindFirstChild("UIStroke") then
                TweenService:Create(obj.UIStroke,TweenInfo.new(0.15),{Transparency=0.4}):Play()
            end
        end)
        obj.MouseLeave:Connect(function()
            TweenService:Create(obj,TweenInfo.new(0.15),{BackgroundTransparency=math.clamp(obj.BackgroundTransparency-0.08,0,1),Position=basePos}):Play()
            if obj:FindFirstChild("UIStroke") then
                TweenService:Create(obj.UIStroke,TweenInfo.new(0.15),{Transparency=0}):Play()
            end
        end)
    end
end
...
game.DescendantAdded:Connect(applyGlass)
