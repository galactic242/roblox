...
--[[i just modified it a little credits to the owners of Rayfield ui lib]]--
...
-- glassmorphism + hover (desktop + mobile safe)
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")

local function tween(obj, props)
    TweenService:Create(obj, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), props):Play()
end
...
local function hook(obj)
    ...
    local baseTrans = obj.BackgroundTransparency
    ...
    local function leave()
        ...
        if stroke then tween(stroke,{Transparency=0.85}) end
    end

    if obj.MouseEnter and obj.MouseLeave then
